...
<body>
	<div class="container-fluid main-container container-fluid-no-padding">
		<div class="container-fluid container-fluid-no-padding">
			<div class="container-fluid container-fluid-no-padding shadow-bottom">
				<div class="container-fluid container-fluid-no-padding navbar-div">
								<nav class="navbar navbar-default navbar-container" role="navigation">
				  <div class="container-fluid navbar-holder">
				    ...
				    <div class="navbar-header">
				      ...
				      <a class="navbar-brand" href="#"><img src="http://peakland//assets/images/common/logo.png"></a>
				    </div>
	...
	<section id="main_inner">
		<!--__FUEL_MARKER__3-->this is the home page	</section>
