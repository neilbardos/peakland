...
<head>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
 	<title>
		<!--__FUEL_MARKER__0-->Peakland::Project	</title>

	<meta name="keywords" content="<!--__FUEL_MARKER__1-->Peakland::Project">
	<meta name="description" content="<!--__FUEL_MARKER__2-->Peakland::Project">

	<link id="page_favicon" href="http://peakland/assets/images/favicon.ico" rel="icon" type="image/x-icon" />
	<!-- Latest compiled and minified CSS -->
	<link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css" type='text/css'>
	<link href="http://peakland/assets/css/font-awesome.min.css" rel="stylesheet">
	<link href="http://peakland/assets/css/jquery.bxslider.css" rel="stylesheet" />
...
<div class="container-fluid main-content-div">
    <div class="container container-fluid-no-padding">
    	<div class="col-md-12 projects-div">
    		<h1 class="about-hdr">Projects</h1>
    		<div class="container container-fluid-no-padding  col-md-12">
				<div class="container col-md-4 container-fluid-no-padding projects-ind-div">
					<div class="container col-md-12 container-fluid-no-padding gradeint-bg">
						<div class="col-md-12 project-logos proj-casa-amaya">&nbsp;</div>
						<div class="col-md-12 project-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh.</div>
					</div>
					<ul class="col-md-12">
						<li>
							<span class="fa-stack fa-lg">
							  <i class="fa fa-square fa-stack-2x"></i>
							  <i class="fa fa-chevron-right fa-inverse fa-stack-1x"></i>
							</span>
							<a href="">Model 45</a>
						</li>
						<li>
				...
				<div class="container col-md-4 container-fluid-no-padding projects-ind-div">
					<div class="container col-md-12 container-fluid-no-padding gradeint-bg">
						<div class="col-md-12 project-logos proj-springtown-villas">&nbsp;</div>
						<div class="col-md-12 project-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh.</div>
					</div>
					<ul class="col-md-12">
						<li>
				...
				<div class="container col-md-4 container-fluid-no-padding projects-ind-div">
					<div class="container col-md-12 container-fluid-no-padding gradeint-bg">
						<div class="col-md-12 project-logos proj-greenridge-ville">&nbsp;</div>
...
<script src="http://peakland/assets/js/jquery.bxslider.min.js"></script>
